...
tiffany_acct = CheckingAccount('Tiffany Richards', 30889956)
# 2.2 Deposit the amount of 1500
tiffany_acct.deposit(1500)
# 2.3 Withdraw the amount of 4000
tiffany_acct.withdraw(4000)
# 2.4 Print the account balance
print(tiffany_acct.balance)

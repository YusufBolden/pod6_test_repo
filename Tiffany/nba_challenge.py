...
print(f"In the 2020 NBA playoffs, James Hardent made {james_harden_3pts_made} 3 point shots")
...
print(f"In the 2020 NBA playoffs, Jamal Murray attempted {jamal_murray_3pts_attempts} 3 point attempts")
print(f"In the 2020 NBA playoffs, Fred Vanvleet attempted {fred_vanvleet_3pts_attempts} 3 point attempts")
print(f"In the 2020 NBA playoffs, James Hardent attempted {james_harden_3pts_attempts} 3 point attempts")
...
print(f"In the 2020 NBA playoffs, Jamal Murray's 3pt percentage was {jamal_murray_3pts_percentage}.")

# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"In the 2020 NBA playoffs, Fred Vanvleet's attempted {fred_vanvleet_3pts_percentage} 3 point attempts")

# TODO: Calculate and print the 3 point percentage for James Harden
print(f"In the 2020 NBA playoffs, James Harden's attempted {james_harden_3pts_percentage} 3 point attempts")
...
jamal_murray_3pts_percentage_str = str(jamal_murray_3pts_percentage)

print(jamal_murray_3pts_percentage_str)

fred_vanvleet_3pts_percentage_str = str(fred_vanvleet_3pts_percentage)

print(fred_vanvleet_3pts_percentage_str)

# james_harden_3pts_percentage_str = str(james_harden_3pts_percentage)

print(str(james_harden_3pts_percentage))

jamal_murray_3pts_percentage_int = int(jamal_murray_3pts_percentage)

print(jamal_murray_3pts_percentage_int)

fred_vanvleet_3pts_percentage_int = int(fred_vanvleet_3pts_percentage)

print(fred_vanvleet_3pts_percentage_int)

james_harden_3pts_percentage_int = int(james_harden_3pts_percentage)

print(james_harden_3pts_percentage_int)

...
#to print all items from a list i will need to set a 'for loop' statement with a print function. 
# 'names' will be used as my iterator to pass through 'all-laptops' so it may print the name of each product. 
print("1) All laptops names:")
print()
...
print(f'2.a) The website to purchase a Macbook Pro is {laptops[0]["url"]}')
# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.

print(f'2.b) The prices of the 16-inch Macbook Pro are ${laptops[0]["types"][1]["price"]}, depending on the specifications that suit you best!')
# TODO: Write code to print all the color options for Dell XPS 13.

print(f'2.c) The colors for the Dell XPS 13 are: {laptops[1]["types"][1]["colors"]}')

# TODO: Write code to print the description of Dell XPS laptop.
print(f'2.d {laptops[1]["description"]}')
#-------------------------------------------------------------------------------------------------------------
...
print("2.e) Apple Macbook Pro 13-inch in Space Gray is not available. The available colors are:",end=" ")
print(f'{laptops[0]["types"][0]["colors"]}')
print("2.f) Apple Macbook Pro 16-inch with a storage of 1 TB SDD is not available. The avaiable capacity is:",end=" ")
print(f'{laptops[0]["types"][1]["storage"]}')

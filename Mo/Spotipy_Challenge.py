...
print()
print("Question 1")
print('1 Import the spotipy API to be able to use it in this challenge')
import spotipy
import pandas as pd
...
print("Question 3")
print("Figure out how to choose the top artist from the search, and get that artist's id:")
#artist_id =   # fill this in
#print(artist_id) # uncomment if you want to see the results
artist_id = (result['artists']['items'][0]['id'])
jprint(result['artists']['items'][0]['id'])
print()
print('==============================================================================================================================================================')

print("Question 4")
print("How popular is Beyoncé? Using her unique artist ID, now let's pull popularity and followers")
#
...
print("Question 5")
print('Pick 5 artists, and construct a pandas dataframe where each row represents a different artist. Include columns for artist name, id, popularity, and followers.')
...
chosen_artists = ['the weeknd','drake','travis','kanye west', 'james blake']
popularities = []
...
for artist in chosen_artists:
    ...
    top5['name'] = artist
    top5['id'] = artistid
    top5['popularity'] = artistinfo['popularity']
    top5['followers'] = artistinfo['followers']['total']
    popularities.append(top5)
jprint(popularities)
print()
print('==============================================================================================================================================================')
print()
print("Question 6")
print('Get the most and least popular artists')
#
...
('==============================================================================================================================================================')
print("Bonus!")
print('Bonus! Get the most similar artists to the last artist in your popularities dataframe, do the popularities match up?')
#
('==============================================================================================================================================================')
related = sp.artist_related_artists(popularities[1]['id'])
print(related['artists'][0]['name'])
print(related['artists'][0]['popularity'])
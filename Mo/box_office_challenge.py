...
print()
print('-----------------------------------------------------')
#convert a string to a list using '.split(",")' funtction
...
print()
print('-----------------------------------------------------')
#(+/-) items from list using  :  (listname).remove(‘name of item’)  or (listname).append(‘name of item’) 
...
print()
print('-----------------------------------------------------')
# Print # of items in a list using:  print(len(name_of_variable)) 
...
print()
print('-----------------------------------------------------')
#Print speficic items from list using:    print(name_of_variable[item#])
print(top_100[0])
print('-----------------------------------------------------')
...
print()
print('-----------------------------------------------------')
#Print  MULTIPLE speficic items from list using:    print(name_of_variable[index# : index#])
print(top_100[0:9])
print('-----------------------------------------------------')
...
print()
print('-----------------------------------------------------')
#- Convert a list to a str :	                   user_defined_variable = ‘,’.join(name_of_string) 

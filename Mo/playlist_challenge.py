...
#everything_is_everything  {'artist': 'Lauryn Hill', 'title': 'Everything Is Everything'}
# The song that you add should be a dictionary, with the following key-value pairs
# 'artist' (string)
# 'title' (string)
#{'artist': 'Lauryn Hill', 'title': 'Everything Is Everything'}
add_song(my_playlist, {'artist': 'Usher', 'title': "Yeah!"})
...
add_song(my_playlist, {'artist': 'Nina Simone', 'title' : 'Baltimore'})
add_song(my_playlist, {'artist': 'The Weeknd', 'title' : 'House of Balloons'})
display_playlist(my_playlist)
...
print('Question 6')
print('7 At the top of this script, import numpy using the usual alias')

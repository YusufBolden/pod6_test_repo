...
# 1.1
print('1.1')
print("Create a function 'available_books' to print the books list")
...
# 1.3
print('1.3')
print("Create a function 'check_out' that removes a book from the books list")
...
# 1.4
print('1.4')
print("Check out 'SAPIENS' using the check_out function")
check_out('SAPIENS')
...
# 1.5
print('1.5')
print("Create a function 'check_in' that adds a book to the books list")
def check_in(checkin):
    books.append(checkin)
# Parameters: book (string)
# Return: Not needed for this function
#-------------------------------------------------------------------------------------------------------------
print()
# 1.6
print('1.6')
print("Check in 'SAPIENS' using the check_in function")
check_in('SAPIENS')
#-------------------------------------------------------------------------------------------------------------
...
# 1.7
print('1.7')
print("Create a function 'search_by_name' that prints 'Available' if exists in books list, 'Not Available' if it doesn't.")
...
books_with_details = [
    ...
    {
        'title': 'MY GRANDMOTHER\'S HANDS', #13
    ...
    {
        'title': 'THE ROAD TO UNFREEDOM', #15
        'author': 'Timothy Snyder',
...
# 2.0
print('2.0')
print("Describe the structure of the data in books_with_details. What types of data are nested within others? How do you know?")
print(type(books_with_details))
print()
# 2.1
print('2.1')
print("Create a function 'count_books' that returns the number of books in the books_with_details list")
# Parameters: Not needed for this function
# Return: number of books (integer)
def count_books():
    print(len('count_books'))

print()
# 2.2
print('2.2')
print("Check the number of books available in the books list using the count_books function")
count_books()
print()
# 2.3
print('2.3')
print("Create a function 'search_by_author' that returns the titles of books by an author")
...
# print(books_with_details[1]['title'])

def search_by_author(name):
    new = []
    for titles in books_with_details:
        if titles['author'] == name:
            new.append(titles['title'])
    return print(new)
...
# 2.4
print('2.4')
print("Search for book titles by the author 'Timothy Snyder' using the search_by_author function")

...
'''
def get_playlist_length(my_playlist):
...
def play_track(playlist, track = 1 ):
	trackname = playlist[track-1]['title']
	trackartist = playlist[track-1]['artist']
	print(f'Now playing{track}, {trackname} by {trackartist}')

...
def withdraw(account, amount):
    if amount <= account['balance']:
        ...
        print(f'Insufficient funds! ${account["balance"]} is your available balance')

withdraw(my_account, 3.20)
print(my_account)

withdraw(my_account, 266.95)
print(my_account)
...
deposit_secure(my_account, 95)
print(my_account)
withdraw_secure(my_account, 15.01)
print(my_account)

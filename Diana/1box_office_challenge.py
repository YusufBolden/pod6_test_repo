...
remaining_50_lists = movies_str.split(",")
print(remaining_50_lists)
...
remaining_50_lists.append("Anywhere But Here")
...
top_100 = remaining_50_lists + top_50_list 

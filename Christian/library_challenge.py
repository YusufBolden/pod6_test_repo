...
def search_by_name(book):
    if book in books:
        print('Perfect!! Your book is available')
    else:
        print('Sorry my guy, this library does not carry this book anymore')    
print()
# 1.8
...
print('books_with_details is a list of dictionaries')

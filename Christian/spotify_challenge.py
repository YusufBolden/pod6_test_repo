...
print("Question 1 - importing spotipy")
...
print("Question 2 - searching by artist")
...
print("Question 3 - locating top artists")
print()
...
print()
print("Question 4 - locating popularity rating\nand total followers using artist id")
...
print()
print("Question 5 - setting up a PANDAS dataframe")
...
chosen_artists = ['Barry Manilow', 'Niel Diamond', 'Engelbert Humperdink', 'The Monkees', 'Jefferson Airplane']
popularities = []
...
sim = sp.artist_related_artists(popularities[1]['id'])

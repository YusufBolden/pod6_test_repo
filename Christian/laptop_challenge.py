...
laptops = [
        ...
        },
        {
            ...
            "types": [
                {
                    ...
                    "colors": ["Platinum silver exterior, with purple interior", "Gold exterior, with black interior"],
            ...
            "description": "The Dell XPS is an absolutely brilliant laptop.\nThe 2020  version rocks an 11th-generation Intel Core i3,\ni5 or i7 processor and a bezel-less ‘Infinity Edge’ display.\nThis Dell XPS continues to be the most popular Windows laptop in the world.\nWhat’s more, there’s a wide range of customization options, so you can really make the Dell XPS the best laptop for your needs. "
        }
]
print()
...
print(f'The website for the Apple Macbook Pro is: {laptops[0]["url"]}')

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.

print()

print(f'The prices for the 16 inch Macbook Pro may vary from :{laptops[0]["types"][1]["price"]}')
...
print(f'The Dell XPS 13 inch comes in an array of colors as follows:\n {laptops[1]["types"][0]["colors"]}')

print()

# TODO: Write code to print the description of Dell XPS laptop.

print(f'The Dell XPS specs are as follows: {laptops[1]["description"]}')
...
laptops[0]["types"][0]["storage"] = ["521 GB"]
...
for cost in laptops:
    for all_costs in cost['types']:
        print(all_costs['price'])

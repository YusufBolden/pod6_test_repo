...
'''
add_song(my_playlist,{'artist': 'Lauryn Hill', 'title': 'Everythin Is Everything'})
...
print('Question 5')
add_song(my_playlist, {'artist': 'Beck', 'title': 'Loser'})
add_song(my_playlist, {'artist': 'Amy Winehouse', 'title': 'Back To Black'})
...
number_of_tracks = get_playlist_length(my_playlist)

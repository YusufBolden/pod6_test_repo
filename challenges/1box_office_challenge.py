...
# this above is a list of strings
print("")
...
remaining_50_list.remove('Cruel Intentions')
print(remaining_50_list)
...
new_employee = "DORIAN MILES"
# first_name.last_name@ourcompany.com
new_employee_lower = new_employee.lower()
print(new_employee_lower)

new_employee_split = new_employee_lower.split(" ")
print(new_employee_split)

new_employee_join = ".".join(new_employee_split)
print(new_employee_join)

final_step = new_employee_join + "@ourcompany.com"
print(final_step)
print(new_employee_join + "@ourcompany.com")
